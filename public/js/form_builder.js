$(document).ready(function () {
        ...
        el.each(function () {
            ...
            if (data_type === 'radio') {
                ...
                $(this).find('.mt-radio').each(function () {
                    ...
                    option_html += '<div class="form-check "><label class="form-check-label radio-inline c-radio"><input type="radio" class="form-check-input" name="' + name + '" value="' + value + '"><span class="fa fa-check"></span>' + option + '</label></div>';
                });
    ...
    $(document).on('click', '.export_html', function () {
        getPreview('html');
        hcode = $('.preview').html();
        orgcode = $('.form_builder_area').html();
        $('.preview').show();
        $('#contenthtml').val(hcode);
        $('#orghtml').val(orgcode);
    });
});