...
<div class="content-wrapper">
  ...
  <div class="content-heading">
   <span><i class="fa fa-group"></i> Edit lead</span>
 </div>

 <div class="panel panel-default">
   <div class="panel-body">
    <form class="form-horizontal" action="{{ route('leads.update',['id'=>$lead->id]) }}" method="post" id="form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
...
<div class="form-group">
 ...
 <div class="col-sm-6">
   @if(file_exists($lead->image))
   <img src="{{ asset($lead->image) }}" style="width:200px;height: auto;padding-top: 20px;">
   @endif
 </div>
</div>
<div class="form-group">
