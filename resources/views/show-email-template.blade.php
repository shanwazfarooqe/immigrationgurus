  ...
  <div class="panel panel-default">
   <div class="panel-body">
    ...
    <div class="container-fluid">
     <div class="row">
      <div class="col-sm-12">
        <form action="{{ route('templates.mail') }}" method="POST" role="form" class="form-horizontal" id="mail-form">
        @csrf
        <input type="hidden" name="template_id" value="{{ $template->id }}">
          <div class="">
           <div  class="card-header">
            <div class="row">
              <div class="col-sm-7">
               <h4><i class="fa fa-object-group"></i> Add Templates</h4>
             </div>
             <div class="col-sm-2">
              <div class="">
               <div class="dropdown">
...
<div class="btn-group pull-right">
 ...
 <a data-edit="redo" data-toggle="tooltip" title="Redo (Ctrl/Cmd+Y)" class="btn btn-default btnwysing">
   <i class="fa fa-repeat"></i>
                ...
                <textarea name="attachments" id="files" cols="30" rows="10" class="hide"></textarea>
                <textarea name="content" id="wysiwygtext" cols="30" rows="10" class="hide"></textarea>
                <textarea name="to" id="totext" cols="30" rows="10" class="hide"></textarea>
                <textarea name="cc" id="cctext" cols="30" rows="10" class="hide"></textarea>
                <textarea name="bcc" id="bcctext" cols="30" rows="10" class="hide"></textarea>
              </form>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="myModal-preview" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="form-group row mrow2 feildup">
        ...
        <div class="input-group m-b ">
         <input type="text" class="form-control " placeholder="To :" style="border: none;" id="to-input">
     ...
     <div class="form-group row mrow2" id="cctoggle" style="display: none"> <input type="text" class="form-control " placeholder="Cc :" style="border: none;" id="cc-input"></div>
     <div class="form-group row mrow2" id="bcctoggle" style="display: none"> <input type="text" class="form-control " placeholder="Bcc :" style="border: none;" id="bcc-input"></div>
