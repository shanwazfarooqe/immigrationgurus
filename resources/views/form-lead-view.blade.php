...
<div class="content-wrapper">
  <div class="content-heading">
   ...
   <div class="pull-right"><a href="{{ route('leads.application',['lead'=>base64_encode($id)]) }}" class="btn btn-sm btn-info"> Form List </a></div>
 </div>
    ...
    <div class="table-responsive">
     ...
     <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{ route('leads.data',['id'=>base64_encode($row->id),'lead'=>base64_encode($id)]) }}" class="btn btn-info btn-xs">View</a>
